...
$.CBPeripheralManager.addMethod('handleMTUChangedSwizzled:', 'v@:@', function($self, $_cmd, $event) {
  $self('handleMTUChangedSwizzled', $event);

  $self('delegate')('peripheralManager', $self, 'centralDidExchangeMTU', $event);
});

$.CBPeripheralManager.getInstanceMethod('handleMTUChanged:').exchangeImplementations($.CBPeripheralManager.getInstanceMethod('handleMTUChangedSwizzled:'));
