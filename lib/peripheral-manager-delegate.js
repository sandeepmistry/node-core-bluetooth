...
CBPeripheralManagerDelegate.addMethod('peripheralManager:centralDidExchangeMTU:',
                                    'v@:@@@', function ($self, $_cmd, $peripheralManager, $event) {

  var $deviceUUID       = $util.objectForKey($event, 'kCBMsgArgDeviceUUID')
  var $mtu              = $util.objectForKey($event, 'kCBMsgArgATTMTU');
